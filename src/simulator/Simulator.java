...
public class Simulator {
	...
	public int getTranspondersODU(int transponderCapacity, int maxBandwidth, String distribution, int pathMode,
		...
		if (!customRequest.isEmpty()) {
			for (CustomRequest cr : customRequest) {
				...
				case 0:
					...
					if (backupPath)
						updateTransponderBandwidth(dsp.getDisjointShortestPath(), traffic);
					break;
				case 1:
	...
	public int getTranspondersHybrid(int transponderCapacity, int maxBandwidth, String distribution, boolean backupPath,
			int threshold) {
